...
function install_virtualization() {
    ...
    # Install only VirtualBox
    log_info "Installing only VirtualBox as requested"
    install_virtualbox || log_warning "VirtualBox installation encountered issues"
    
    # Skip other virtualization tools
    log_info "Skipping QEMU/KVM installation as requested"
    log_info "Skipping additional virtualization tools as requested"
    log_info "Skipping Vagrant installation as requested"
