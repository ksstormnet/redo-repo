...
function install_brave_browser() {
    ...
    log_info "Installing dependencies for Brave Browser"
    local dependencies=(
        apt-transport-https
        curl
        gnupg
    ...
    if ! apt_install "${dependencies[@]}"; then
        log_warning "Failed to install some dependencies. This might affect Brave installation."
    fi
...
function install_microsoft_edge() {
    ...
    # Install dependencies
    log_info "Installing dependencies for Microsoft Edge"
    local dependencies=(
        apt-transport-https
        curl
        gnupg
    ...
    if ! apt_install "${dependencies[@]}"; then
        log_warning "Failed to install some dependencies. This might affect Edge installation."
    fi
